...
const TeamSection = () => {
  const team = [
    {
      ...
      education:
        "Absolwentka Uniwersytetu WSB Merito Wrocław - kierunek rachunkowość",
      experience:
        "Doświadczenie praktyczne od 2011 roku, własne biuro od 2018 roku",
      description:
        "Na co dzień doradza przedsiębiorcom, przeprowadza konsultacje oraz wspiera w zrozumieniu skomplikowanych przepisów podatkowych. W pracy ceni bezpośredni kontakt z klientami, szczerość i otwartość.",
      photo: "/photos/71.jpg",
    ...
    },
    {
      ...
      role: "Księgowa",
      education:
        "Magister finansów i rachunkowości - Uniwersytet WSB Merito Wrocław",
      experience:
        "Doświadczenie w księgowości od 2018 roku, tytuł magistra w 2022 roku",
      description:
        "Specjalizuje się w kompleksowej obsłudze księgowej firm, rozliczeniach kadrowo-płacowych oraz analizie przepisów prawa podatkowego i gospodarczego. Szczególną wagę przywiązuje do profesjonalizmu i rzetelności.",
      photo: "/photos/77.jpg",
  ...
  return (
    <section
      id="o-nas"
      className="py-20 bg-gradient-to-br from-gray-50 via-indigo-50/30 to-blue-50/40 relative overflow-hidden"
    >
      {/* Animowane tło */}
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          className="absolute bottom-20 right-20 w-96 h-96 bg-gradient-to-tr from-blue-300/10 via-cyan-400/10 to-teal-300/10 rounded-full blur-3xl animate-pulse"
          style={{ animationDelay: "1.5s" }}
        ></div>

        {/* Floating elements */}
        <div
          className="absolute top-1/3 right-1/4 w-4 h-4 bg-primary/20 rounded-full animate-bounce"
          style={{ animationDelay: "0.5s" }}
        ></div>
        <div
          className="absolute bottom-1/3 left-1/4 w-3 h-3 bg-secondary/20 rounded-full animate-bounce"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute top-1/2 left-1/6 w-2 h-2 bg-accent/20 rounded-full animate-bounce"
          style={{ animationDelay: "1.5s" }}
        ></div>
      </div>
            ...
            >
              <Card className="border-0 shadow-lg hover:shadow-2xl transition-all duration-500 group relative overflow-hidden bg-white/80 backdrop-blur-sm">
                ...
                <CardContent className="p-8 relative z-10">
                  ...
                  >
                    <div>
                      <h4 className="font-semibold text-primary mb-1 group-hover:text-primary/90 transition-colors duration-300">
                        Wykształcenie:
                      </h4>
        ...
        >
          ...
          >
            ...
            <p className="text-gray-600 italic relative z-10">
              Wspólnie tworzymy zespół, który łączy profesjonalizm z
